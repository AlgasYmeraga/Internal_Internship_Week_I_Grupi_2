...
void showRanking(StudentProgress records[], int count) {
    ...
    for (i = 0; i < count; i++) {
        ...
        } else if (records[i].score >= 90) {
            printf("Koment: Rezultat shume i larte.\n");
        } else if (records[i].score >= 70) {
            printf("Koment: Rezultat i mire.\n");
        } else if (records[i].score >= 50) {
...
int main() {
    ...
    do {
        printf("\n========================================\n");
        printf(" Student Progress Tracker - Task 6\n");
        printf("========================================\n");
        ...
        choice = readInt("Zgjedh nje opsion: ", 1, 7);
